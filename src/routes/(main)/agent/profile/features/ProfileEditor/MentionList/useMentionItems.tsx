...
// Get Klavis server type configuration by identifier
 ...
 * For string type icons, renders using the Image component
 * For IconType icons, renders using the Icon component with theme-based fill color
 */
const KlavisIcon = memo<Pick<KlavisServerType, 'icon' | 'label'>>(({ icon, label }) => {
  ...
  // Fill with theme color, auto-adapts in dark mode
