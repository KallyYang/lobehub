...
const MCPManifestForm = ({ form, isEditMode }: MCPManifestFormProps) => {
  ...
  const handleTestConnection = async () => {
    ...
    try {
      ...
      // If HTTP type, also validate authentication fields
      if (mcpType === 'http') {
    ...
    try {
      ...
      if (result.success && result.manifest) {
        ...
        // The store has already handled the error state; optionally show additional user-friendly messages here
                ...
                rules={[
                  { message: t('dev.mcp.url.required'), required: true },
                  {
                    ...
                    validator: async (_, value) => {
                      ...
                      // Automatically throws if the value is not a valid URL
                      new URL(value);
                    },
                  },
                ]}
